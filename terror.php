...
<nav class="navbar navbar-expand-md bg-info navbar-dark text-white fixed-top justify-content-center ">
    ...
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle bg-info text-white" href="#" id="navbardrop" data-toggle="dropdown">Seleccone Genero</a>
    ...
    <thead>
      <tr>
        ...
        <td>DESCRIPCION</td>
			...
			<?php
			$sql="select * from peliculas WHERE ID_GENERO = '4'";
